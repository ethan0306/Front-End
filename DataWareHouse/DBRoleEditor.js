(function () {
    ...
    mstrmojo.requiresCls(
            ...
            "mstrmojo.Table",
            "mstrmojo.Editor",
            "mstrmojo.WH.DBRoleSetting",
            "mstrmojo.WH.DBRoleDSNConnection",
            "mstrmojo.WH.DBRoleSettingPulldown"
            );
    ...
    mstrmojo.WH.DBRoleEditor = mstrmojo.declare(
        // superclass
        mstrmojo.Editor,
        // mixins
        null,
        // instance members
        {
            scriptClass: "mstrmojo.WH.DBRoleEditor",
        	...
        	children: [ {//Connection Label
						...
						{//widget that decodes and displays the dsn info
							scriptClass:"mstrmojo.WH.DBRoleDSNConnection",
						...
						{//login	
							scriptClass: "mstrmojo.WH.DBRoleSetting",
				        	   	alias: "txtlogin",
				        	   	caption: mstrmojo.desc(8513, "login:")
						},
						
						{//pwd	
							scriptClass: "mstrmojo.WH.Password",
				        	   	alias: "txtpwd",
