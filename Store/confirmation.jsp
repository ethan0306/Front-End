...
<div id="order_info" data-role="page"
 ...
 <div data-role="header"
		...
		<dsp:form id="reviewOrderForm" name="reviewOrderForm" action="/mas/confirmation.jsp" method="post">	
	 ...
	 <div class="product">
      ...
      <div class="items">
		 ...
		 <dsp:input bean="CommitOrderFormHandler.orderId" beanvalue="ShoppingCart.current.id" type="hidden"/>
				...
				<dsp:input bean="CommitOrderFormHandler.commitOrderErrorURL" type="hidden" value="/mas/confirmation.jsp"/>
