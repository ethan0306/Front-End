(function(){
	 ...
	 */
    mstrmojo.QB.DBTableRow = mstrmojo.declare(
    		// superclass
    		mstrmojo.Container,
    		...
    		
    		{
	            ...
	            ondrop: function ondrop(c) {
	            	var srcw = c.src.widget,
            	        tgtw = c.tgt.widget,            	   
            	        qdl=mstrmojo.all.QBuilderModel;
	            	
	            	if (srcw.domNode.className.indexOf("mstrmojo-qb-DBTableRow")<0)
	            		return;
	            	if (srcw.srcID== tgtw.srcID){
	            	    return;	
	            	}	           
	         
	            	var linker=this.parent.parent.parent.parent.linker;
	            	...
	            	if (qdl.joinsInfo[srcw.srcID+tgtw.srcID]){
	            		  qdl.addLink(srcw, tgtw, srcw.srcID+tgtw.srcID, cb);
	            	}
	            	else if(qdl.joinsInfo[tgtw.srcID+srcw.srcID]){
	            		qdl.addLink( tgtw,srcw,tgtw.srcID+srcw.srcID, cb);
	            	}
	            	else{
	            	    qdl.addJoin(srcw,tgtw , 0, null, cb);
	            	}
	           ...
	           touchSwipeMove: function(t) {
	            ...
	            onTouchDrop: function ondrop(c,x,y) {
	            	var srcw = c,
            	        tgtw = this,            	   
            	        qdl=mstrmojo.all.QBuilderModel;
