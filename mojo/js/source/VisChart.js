					 ...
					 */
			{
				...
				drawLabels: function drwlbls() {
					...
					for(var i = 0; i < l; i++) {
						...
						if(lbl && (dgl & this.drawHorizontalGridLines) && i > 0 && i < l - 1) {
							utils.drawHighlightLine(this, y);
						}
					}
				},
				...
				handleTouchMove: function handleTouchMove(touchX, touchY) {
		            ...
		            var TouchScroller = mstrmojo.TouchScroller,
		            	scrollerOffsets = (TouchScroller && TouchScroller.getScrollPositionTotals(this.parent)) || { x: 0, y:0}; // for Web visualizations
					touchX = touchX - me.offsetLeft + scrollerOffsets.x;
					touchY = touchY - me.offsetTop + scrollerOffsets.y;
					...
					if (touchVal !== null && touchVal !== me.currentHighlight) {
