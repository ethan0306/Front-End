(function(){
	 ...
	 */
    mstrmojo.Architect.DBTable = mstrmojo.declare(
    		// superclass
    		mstrmojo.Editor,
    		...
    		
    		{
				 ...
				 * @Class name
				 */
    			scriptClass: "mstrmojo.Architect.DBTable",
    			title: '',
    	        ...
    	        left: '',    	        
	   	        ...
	   	        markupString: 	'<div id="{@id}" class="mstrmojo-Editor-wrapper">' +
	   	        					'<div class="mstrmojo-Editor {@cssClass}" style="z-index:{@zIndex};{@cssText}" mstrAttach:mousedown,mouseup,click>' + 
		   	        					   '<div style="position:absolute;border-top-left-radius: 5px;border-top-right-radius: 5px; height: 20px;">' +
									      ...
									      '<div class="mstrmojo-Editor-titleSpacer"></div>{@titlebarHTML}' +
	   	        					      '<div class="mstrmojo-Editor-content" style="overflow-x:hidden; overflow-y:auto; padding:0px;"></div>' +
                ...
                ondragmove: function ondragmove(ctxt){
                    ...
                    if (dir) { //dragging on the resize handle                   
                    	...
                    	case 'west':
	                      ...
	                      var mw=true,mh=true,tbls=ts.tlist.children;
	                      ...
	                      if(mw) {
	                    	 ...
	                    	 if(ts.maxWidth>w){
	                           ts.tlist.domNode.style.width=ts.maxWidth+'px';
	                    	   ts.tlist.width  = ts.maxWidth+'px';
                              }
	                      }
	                   ...
	                   // Renew the maxHeight value for all tables
	                      ...
	                      if(mh) {
	                    	 ...
	                    	 if(ts.maxHeight>h){
	                    	  ts.tlist.domNode.style.height=ts.maxHeight+'px';
	                    	  ts.tlist.height =ts.maxHeight+'px';
	                    	 }
	                      } 
	                      st.left = vl+"px";
	                      st.top = vt+"px"; 
